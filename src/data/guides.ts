...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          "Take one job — a 300 square foot backyard putting green — on two lots on opposite sides of the line. In Sunset Beach the UDO requires a zoning permit for any activity proposing to increase impervious square footage, and a stormwater management plan wherever impervious coverage increases by more than 200 square feet, plus an as-built survey stating impervious percentages. A 300 square foot green clears that 200 square foot line with room to spare.",
          "Sunset Beach also has the cleanest written route in this market, one that does not require arguing preemption: its impervious surface definition admits alternative materials on a letter under seal from a licensed and certified North Carolina professional engineer certifying hydraulic conductivity of 1.41 inches per hour or greater. Down US 17 in Little River — unincorporated Horry County — the same green is a landscaping job: 300 square feet is nowhere near the one-half acre of land disturbance that triggers a county stormwater permit, so no stormwater plan and no as-built survey. There is also no statute saying the turf does not count if the question comes up. North Carolina asks for more paperwork and then gives you the better answer."
        ]
      },
      {
    ...
    "faq": [
      {
        ...
        "a": "It depends which side of the line you are on. In Sunset Beach a zoning permit is required for any activity proposing to increase impervious square footage, and a stormwater management plan once impervious coverage increases by more than 200 square feet. In unincorporated Horry County the county stormwater permit trigger is one-half acre or more of land disturbance, so most residential jobs fall below it. Inside a CAMA Area of Environmental Concern in Brunswick County, a CAMA permit is required before excavation, filling or land alteration begins."
      },
      {
    ...
    "sources": [
      ...
      },
      {
        ...
        "cite": "Sec. 2.3 requires a stormwater permit where one-half acre or more is disturbed or the work is part of a Larger Common Plan. Full text of all 134 pages contains no mention of artificial turf, synthetic turf or synthetic grass. Retrieved via an Internet Archive capture dated 2026-04-15; horrycountysc.gov refused connections during research.",
  ...
  },
  {
    ...
    "title": "No Turf Rebates in Horry County | TIMELESS Grass & Greens",
    "description": "There is no turf, water or landscape rebate in Horry County. We checked GSWSA and searched the county, Myrtle Beach and North Myrtle Beach codes: zero hits.",
    "h1": "There are no artificial turf rebates in Horry County",
    "market": "grand-strand",
    "updated": "2026-09-08",
    "answer": {
      "question": "Are there any rebates for artificial turf in Myrtle Beach or Horry County?",
      "answer": "No. We install artificial turf across Horry County, South Carolina, and we found no turf, water or landscape rebate here. Grand Strand Water & Sewer Authority offers none, and the Horry County, Myrtle Beach and North Myrtle Beach codes contain none. Rebate figures you may have seen online come from western water providers, not from here."
    },
    "sections": [
      {
      ...
      {
        "h2": "The one Horry County charge turf can move — and it moves the wrong way",
        "body": [
      ...
      },
      {
        ...
        "body": [
          ...
          "If a contractor cannot produce that document, there is no rebate to collect. In Horry County we could not find a program that publishes one. Two gaps: our search covered Horry County jurisdictions only, so it says nothing about Georgetown County — Murrells Inlet, Pawleys Island — and it does not cover the North Carolina towns just over the state line either: Shallotte, Calabash, Carolina Shores, Sunset Beach, Ocean Isle Beach. Call 303-349-2368 with any question on this page."
        ]
      }
    ],
    "faq": [
      {
        ...
        "a": "No. Its Smart Irrigation and Water Conservation Tips pages carry no rebate, no incentive and no irrigation-meter program. We also searched the Horry County, Myrtle Beach and North Myrtle Beach codes and found no water-conservation rebate or landscape-conversion provision in them."
      },
      {
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          "The mechanism is measured, not argued. Synthetic grass reflects about 6.9% of sunlight against 12.6% for natural grass, and latent heat flux measured 113 W/m² over natural grass against 58 W/m² over synthetic. Grass is cool because it reflects more and evaporates water. Plastic does neither, and no infill changes that.",
          ...
          "Two things do work. Shade is the large one: in that 2024 review, 30 mm synthetic grass averaged 57.5°C in sun against 32.2°C in shade. Where the turf goes matters more than what fills it. The second is naming the problem correctly — the same review found air over synthetic ran only 0.5-1.2°C warmer than over grass, and wet bulb globe temperature showed no significant difference. This is a contact problem — bare feet, paws, a toddler lying down — not a heat stress problem for someone standing on it in shoes."
        ]
      },
      {
    ...
    "faq": [
      {
        ...
        "a": "Generally not, if it cannot be seen. Fla. Stat. 720.3045 says an association may not restrict items on a parcel that are \"not visible from the parcel's frontage or an adjacent parcel, an adjacent common area, or a community golf course,\" and it names artificial turf outright. A fenced rear yard usually qualifies. A yard backing onto a fairway in Ponte Vedra or World Golf Village usually does not."
      },
      {
    ...
    "faq": [
      {
        ...
        "a": "There is no turf or landscaping license in South Carolina. But SC Code 40-11-30 requires a contractor's license for construction work over $10,000, and turf is \"improvement of any kind to real property\" under 40-11-20(10). Below that figure the position is genuinely unsettled: landscaping appears in neither Chapter 40-11 nor the 40-59 residential specialty list, and llr.sc.gov was unreachable when we checked, so we could not read the Board's guidance on when a license is required. Ask any installer to show you a written classification from the Board rather than an opinion."
      },
      {
      ...
      },
      {
        ...
        "a": "Not for the turf itself. Fla. Stat. 163.211 preempted the licensing of occupations to the state and pre-2021 local licensing expired on 1 July 2025. Nassau County's own notice confirms its remaining categories mirror the state DBPR, CILB and ECLB ones, and Jacksonville's s. 342.110 list contains no landscaping or turf entry. Do check the irrigation portion — Jacksonville licenses irrigation installations at s. 342.110(m) and Nassau still issues irrigation certificates, so ask who is capping or rerouting your system and under whose number."
      },
      {
    ...
    "sections": [
      {
        ...
        "body": [
          ...
          "So the word \"turf\" is not what gets regulated. Two other things are: the <strong>dollar value</strong> of the job, which triggers a license in the Carolinas, and the <strong>adjacent trades</strong> a crew touches on the way through — grading, irrigation, electrical, plumbing — several of which are licensed where turf is not. An installer who says \"no license is required for turf\" is usually right about the word and wrong about the job."
        ]
      },
      {
      ...
      },
      {
        ...
        "body": [
          ...
          "Above $40,000 a general contractor license normally applies, though G.S. 89D-12(c) exempts a licensed landscape contractor. Irrigation is separate again: G.S. 89G-3(5) exempts it only below $2,500 per job site. Verify at <em>public-nclclb.arlsys.com/Public/Search</em>. This is the line our own service area crosses, and it is a licensing line rather than a construction one: a $12,000 green in Little River, South Carolina is over that state's $10,000 contractor-licensing threshold; the same green in Shallotte, North Carolina is under North Carolina's $30,000 landscape contractor one."
        ]
      },
      {
      ...
      {
        "h2": "Florida: no DBPR category, and the county cards expired",
        "body": [
          "Florida's definition of contractor reaches work improving \"any building or structure, including related improvements to real estate\" with a job scope \"substantially similar\" to a listed category. Turf laid on grade is not on that list, so no Florida installer can produce a DBPR turf license.",
  ...
  },
  {
    ...
    "description": "NC excludes draining turf from built-upon area (G.S. 143-214.7D). SC has no turf ordinance in the codes we searched. County-by-county stormwater answers.",
    "h1": "Is artificial turf impervious? Stormwater and built-upon area, county by county",
    "market": "all",
    "updated": "2026-09-08",
    "answer": {
    ...
    "sections": [
      {
        "h2": "Two different questions hide in one word",
        "body": [
          "A homeowner asking this wants to know whether water goes through. A plan reviewer asking it wants to know whether the turf counts. Only the second question decides your permit. Turf backing is perforated, so rain does pass through the carpet. What the code weighs is the assembly underneath: pad, infill and compacted stone base. South Carolina and Florida call the test <strong>impervious surface</strong>. North Carolina calls it <strong>built-upon area</strong>.",
          "That is not academic. Many lots carry a coverage cap — Brunswick County's Water Quality Protection Overlay at Sec. 4.8.7.E caps built-upon area at 25 percent of the lot — and crossing it means redesigning the job. Horry County scales its stormwater service charge for non-single-family parcels by impervious percentage. We install in four states and the answer differs in all four."
        ]
      },
      {
        "h2": "North Carolina answers it in writing",
        "body": [
          "North Carolina is the only one that answers by statute. G.S. 143-214.7D(b)(6), enacted by S.L. 2024-49 s. 4.48(b), says that for purposes of implementing State or local government stormwater programs, artificial turf is not built-upon area and not an impervious surface where it is manufactured to allow water to drain through the backing and installed according to the manufacturer's specifications over a pervious surface. Both conditions are load-bearing.",
          "Subsection (d) stops a town writing its own answer: it preempts a local definition of built-upon area or impervious surface that does not comply with subsection (b). Several local codes have not caught up. Brunswick County's stormwater ordinance omits turf from its built-upon area exclusions at Section 1.5(d), and its 491-page UDO never mentions turf while calling compacted earth and gravel impervious. Shallotte's UDO carries amendments through April 2026 and still has not conformed either definition.",
          "Sunset Beach avoids the preemption argument entirely. Its UDO accepts alternative materials on certification by a licensed North Carolina professional engineer, under seal, that they meet a hydraulic conductivity of 1.41 inches per hour or greater. The assembly that satisfies that, and that the Landscape Contractors' Licensing Board workmanship rule at 21 NCAC 28B .0503(b) points at as well: compacted sub-grade pitched to drain, four inches of number 57 stone over geotextile — which the statute already declares not built-upon area — then drainable-backed turf to manufacturer spec."
        ]
      },
      {
        "h2": "South Carolina has written nothing at all",
        "body": [
          "On the South Carolina side there is no ordinance to read. We searched Horry County Code Chapter 17.7 and its zoning appendix, the Myrtle Beach and North Myrtle Beach codes, and all 134 pages of the Horry County Stormwater Management Design Manual. Not one of them contains the words artificial turf, synthetic turf, artificial grass or synthetic grass. Nothing in them prohibits turf, and nothing in them accommodates it — each permit gets decided by a staff member applying a general definition to a product it was never written for.",
          "What fills the vacuum is unhelpful. Horry County Sec. 17.7-16 lists common impervious surfaces including compacted gravel and soil surfaces, awnings and other fabric or plastic coverings. Turf is not named, but a turf system is a plastic covering over a compacted gravel base, and both phrases sit in the county's own list. The saving grace is that the definition closes on a performance test — surfaces which prevent or impede the natural infiltration of stormwater runoff — so a free-draining system with infiltration data is arguable. Myrtle Beach's zoning definition is harsher still, benchmarking against the rate of absorption of vegetations-bearing soils, which is exactly the live lawn turf replaces.",
          "North Myrtle Beach is the closest thing to a written way in, and it gets there without ever using the word turf. Sec. 23-129.4, added by Ord. No. 25-45 in October 2025, counts a surface pervious if water infiltrates through it, it demonstrates a minimum infiltration rate of two inches per hour based on manufacturer testing, it is installed to spec, it passes inspection and it is maintained. It closes with a line worth reading twice: if these criteria are not met, the surface will be considered impervious, regardless of material type or labeling."
        ]
      },
      {
      ...
      },
      {
        ...
        "body": [
          "HB 683 (2025) created s. 125.572, and the preemption went live when DEP adopted Rule 62-308.100, F.A.C., effective 19 May 2026. No city or county can now ban compliant synthetic turf on single-family residential property, or regulate it inconsistently with the DEP standard. Compliance is the price of that protection. DEP's proposed rule of January 2026 set out the standard: permeable turf on permeable backing over a pervious subgrade of washed natural material, soil beneath not compacted to the extent that it adversely impacts percolation, and no increase in runoff volume, direction or rates to adjacent properties. Our <a href='/guides/florida-turf-infill-rules/'>Florida infill guide</a> works from the adopted text; check it before you rely on these details.",
      ...
      },
      {
        ...
        "body": [
          ...
          "Some gaps remain. Conway and Surfside Beach zoning were retrieved only at chapter level, so treat those two as unverified rather than clear. Georgetown County, which includes Murrells Inlet, was not researched, and neither was Clay County in Florida. The Carolina Shores ordinance text sits behind a Cloudflare challenge and we could not read it. On a North Carolina waterfront lot, turf is not allowed inside the 30-foot coastal shoreline buffer (see the <a href='/guides/nc-vs-sc-built-upon-area/'>North Carolina and South Carolina guide</a>); outside it, ask for a written determination before work starts."
        ]
      }
    ],
    "faq": [
      {
        "q": "Does artificial turf count against my lot's impervious coverage limit?",
        "a": "In North Carolina, no — G.S. 143-214.7D(b)(6) excludes turf manufactured to drain through the backing and installed per manufacturer spec over a pervious surface. In South Carolina nothing is written either way in the codes we searched, so it turns on how a reviewer reads a general definition. In northeast Florida it varies by town, from St. Johns County's narrow parking-and-roadway wording to Atlantic Beach's base-and-lining test. We found no Colorado statute or Denver-metro ordinance classifying turf for coverage purposes."
      },
      {
      ...
      },
      {
        ...
        "a": "It can, where a jurisdiction classes it impervious. Myrtle Beach bills on an equivalent residential unit of 5,000 square feet of impervious area; North Myrtle Beach uses 3,500. A 2,000 square foot back-yard install is roughly 0.4 of a Myrtle Beach unit and 0.57 of a North Myrtle Beach one — small for a homeowner, real on a commercial parcel, where Horry County scales the charge by impervious percentage."
      },
      {
        "q": "Rain drains through turf, so why does any of this matter?",
        "a": "Because the turf is not the bottleneck. New Jersey's environment department put it plainly in its 2025 science review: a product that drains ten inches per hour does not mean the ground underneath will infiltrate at that rate. Water that goes through the carpet still has to get somewhere — into the soil, into a stone reservoir, or out to a drain. That is what the base detail is for, and it is what a plan reviewer is actually asking about."
      }
    ],
    "sources": [
      {
        "label": "N.C. Gen. Stat. 143-214.7D",
        "cite": "Subsection (b)(6) excludes from built-upon area \"artificial turf, manufactured to allow water to drain through the backing of the turf, and installed according to the manufacturer's specifications over a pervious surface\"; (b)(3) does the same for #57 stone at least four inches thick over geotextile; (d) preempts conflicting local definitions. Enacted by S.L. 2024-49 s. 4.48(b).",
        "url": "https://www.ncleg.gov/EnactedLegislation/Statutes/HTML/BySection/Chapter_143/GS_143-214.7D.html",
        "checked": "2026-09-07"
      },
      {
        "label": "21 NCAC 28B .0503(b) — NC Landscape Contractors' Licensing Board rules",
        "cite": "Artificial turf workmanship standard: \"Ensure that the sub-grade is compacted and shall pitch properly to drain\", plus perimeter attachment, nap direction, an evenly weighted sand layer and manufacturer specifications.",
        "url": "http://reports.oah.state.nc.us/ncac/title%2021%20-%20occupational%20licensing%20boards%20and%20commissions/chapter%2028%20-%20landscape%20contractors/chapter%2028%20rules.pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "Brunswick County Stormwater Quality Management and Discharge Control Ordinance",
        "cite": "Section 1.5(d) defines built-upon area with exclusions for slatted wood decks, pool water, #57 stone over geotextile and trails — artificial turf is not listed.",
        "url": "https://www.brunswickcountync.gov/DocumentCenter/View/7215",
        "checked": "2026-09-07"
      },
      {
        "label": "Brunswick County Unified Development Ordinance",
        "cite": "Impervious surface defined to include compacted earth and gravel. Full-text search of the 491-page UDO returns no occurrence of \"artificial turf\" or \"synthetic turf\". The Water Quality Protection Overlay at Sec. 4.8.7.E caps built-upon area at 25 percent of the lot.",
        "url": "https://www.brunswickcountync.gov/DocumentCenter/View/5460",
        "checked": "2026-09-07"
      },
      {
        "label": "Town of Shallotte Unified Development Ordinance (amendments through April 2026)",
        "cite": "Impervious surface at (126) covers compacted earth, gravel, concrete and asphalt; built-upon area covers \"buildings, pavement, gravel roads, and recreation facilities\". Neither definition has been conformed to G.S. 143-214.7D.",
        "url": "https://www.townofshallotte.org/vertical/sites/%7B84A9E943-E9D6-4534-99F0-B6F654F25036%7D/uploads/2026-03-24_Shallotte_UDO_(1).pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "Town of Sunset Beach Unified Development Ordinance",
        "cite": "\"Alternative materials, not subject to the definition of impervious surface, may be proposed subject to certification of a licensed and certified North Carolina professional engineer of compliance with the hydraulic conductivity standard of 1.41 inches per hour or greater. Such certification shall be in the form of a letter under seal.\"",
        "url": "https://rebuild-sunsetbeachnc.govoffice2.com/vertical/Sites/%7BC59DF5BC-1B90-44CB-AD2A-9DAE0D811CD0%7D/uploads/2023_ToSB_UDO_(Working_Copy)_Full.pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "Horry County Code Sec. 17.7-16 (Stormwater Utility, Definitions)",
        "cite": "\"Common impervious surfaces include, but are not limited to, rooftops, sidewalks, walkways, patio areas, driveways, parking lots, storage areas, compacted gravel and soil surfaces, awnings and other fabric or plastic coverings, and other surfaces which prevent or impede the natural infiltration of stormwater runoff which existed prior to development.\" Artificial turf is not named.",
        "url": "https://library.municode.com/sc/horry_county/codes/code_of_ordinances?nodeId=COOR_CH17.7STMA_ARTIISTUTFE_S17.7-16DE",
        "checked": "2026-09-07"
      },
      {
        "label": "Horry County Code Sec. 17.7-17 (Stormwater service charge)",
        "cite": "Non-single-family parcels are assigned a development intensity factor by impervious percentage — 90–100% = 0.95 down to less than 1% = 0.01 — billed per 20,000 square feet of land area.",
        "url": "https://library.municode.com/sc/horry_county/codes/code_of_ordinances?nodeId=COOR_CH17.7STMA_ARTIISTUTFE_S17.7-17STSECHRA",
        "checked": "2026-09-07"
      },
      {
        "label": "Horry County Stormwater Management Design Manual (January 2024)",
        "cite": "Sec. 2.3: a stormwater permit is required where one-half acre or more will be disturbed, or the construction is part of a Larger Common Plan. No mention of artificial turf, synthetic turf or synthetic grass appears in its 134 pages. Note: horrycountysc.gov was unreachable on the check date, so the document was read from the Internet Archive capture of this URL dated 2026-04-15.",
        "url": "https://www.horrycountysc.gov/media/4wqkxbxg/horry-county-sw-design-manual_rev2024.pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "Myrtle Beach Zoning Code, Appendix A Sec. 203",
        "cite": "\"Impervious Surface: Any material that prevents, impedes, or slows infiltration or absorption of storm and surface water directly into the ground at the rate of absorption of vegetations-bearing soils.\" Impervious lot coverage expressly counts \"stone, shell or gravel surfacing\".",
        "url": "https://library.municode.com/sc/myrtle_beach/codes/code_of_ordinances?nodeId=COOR_APXAZO_ART2DE_S203DE",
        "checked": "2026-09-07"
      },
      {
        "label": "Myrtle Beach Code Sec. 18-3 (Stormwater, Definitions)",
        "cite": "\"The equivalent residential unit is 5,000 square feet of impervious surface area.\" The stormwater chapter's impervious definition is narrower than the zoning code's. North Myrtle Beach Sec. 15-92(c) sets its equivalent runoff unit at 3,500 square feet of impervious area.",
        "url": "https://library.municode.com/sc/myrtle_beach/codes/code_of_ordinances?nodeId=COOR_CH18STMA_ARTIINGE_S18-3DE",
        "checked": "2026-09-07"
      },
      {
      ...
      {
        "label": "Fla. Stat. 125.572 — Regulation of synthetic turf",
        "cite": "Created by HB 683 (2025), ch. 2025-140. Subsection (3)(a) bars a local government from prohibiting compliant synthetic turf on single-family residential property, or regulating it inconsistently with DEP standards, once DEP adopts rules under the section.",
        "url": "https://www.leg.state.fl.us/Statutes/index.cfm?App_mode=Display_Statute&Search_String=&URL=0100-0199%2F0125%2FSections%2F0125.572.html",
        "checked": "2026-09-07"
      },
      {
        "label": "Rule 62-308.100, F.A.C. — Synthetic Turf",
        "cite": "Effective 19 May 2026, rule file date 29 April 2026, history note \"New 5-19-26\". This adoption is what triggered the s. 125.572 preemption.",
        "url": "https://www.flrules.org/gateway/ruleNo.asp?id=62-308.100",
        "checked": "2026-09-07"
      },
      {
        "label": "Florida DEP proposed rule text for 62-308.100 (January 2026)",
        "cite": "\"Synthetic turf must be permeable and affixed to permeable backing with a pervious subgrade. A local government may establish a quantifiable standard of a maximum of 10 inches per hour for all layers.\" Subgrade must be washed natural material; \"Soil beneath installed subgrade shall not be compacted to the extent that it adversely impacts percolation\"; installations must prevent pooling or an increase in the stormwater runoff volume, direction, or rates to adjacent properties, and may not be installed within a swale, ditch, stormwater pond or a pond's littoral zone. This is the proposed text as published in January 2026, not the adopted rule document.",
        "url": "https://floridadep.gov/sites/default/files/Proposed%20Rule%20%28Jan%202026%29.doc",
        "checked": "2026-09-07"
      },
      {
        "label": "St. Johns County Land Development Code (edition of 4 March 2025)",
        "cite": "Article XII: \"Impervious Surfaces: Any Building, concrete, pools, wet retention/detention areas, pavement or compacted materials utilized for parking or roadways.\" Full-text search of the consolidated LDC returns zero occurrences of artificial turf, synthetic turf, artificial grass or synthetic grass.",
        "url": "https://www.sjcfl.us/wp-content/uploads/2024/01/entire-ldc-march-4-2025.pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "Nassau County Code, Appendix D (Roadway and Drainage Standards), Art. 10 Sec. 10.8(4)",
        "cite": "On-site stormwater storage is required for any addition or modification on a developed lot with more than 20 percent impervious area, subject to exemptions including \"(c) Pavers are allowed as pervious if shown as engineered with a detail submitted in the application permit\" and \"(f) Small scale development activities under two-hundred and fifty (250) square feet\".",
        "url": "https://library.municode.com/fl/nassau_county/codes/code_of_ordinances?nodeId=APXDRODRST",
        "checked": "2026-09-07"
      },
      {
        "label": "Atlantic Beach Code Sec. 24-17 and Sec. 24-89(c)(1)",
        "cite": "Impervious surface means surfaces \"made of concrete, asphalt, brick, plastic, or any solid surfacing material with a base or lining of an impervious material\". Development resulting in more than 35 percent impervious lot coverage must provide on-site stormwater storage for the entire impervious surface area, with a cumulative 400 square foot exemption.",
        "url": "https://library.municode.com/fl/atlantic_beach/codes/code_of_ordinances?nodeId=PTIICOOR_CH24LADERE_ARTIILADE_S24-17DE",
        "checked": "2026-09-07"
      },
      {
        "label": "St. Augustine Beach Code Sec. 15-17",
        "cite": "\"Impervious area means any part of any parcel of land that has been modified by the action of persons to reduce the land's natural ability to absorb and hold rainfall... Excluded are all lawns, landscape areas, and gardens or farming areas.\"",
        "url": "https://library.municode.com/fl/st._augustine_beach/codes/code_of_ordinances?nodeId=PTIICOOR_CH15PLDE_ARTIICOSTMASYPROULI_S15-17DE",
        "checked": "2026-09-07"
      },
      {
        "label": "City of St. Augustine Code Sec. 29-2 and Sec. 19-16",
        "cite": "Sec. 29-2 excludes \"all lawns, landscape areas, water and other areas designated by the city manager\" from impervious area. Sec. 19-16 lists \"artificial turf/sod\" among acceptable maintained yard surfaces, expressly contrasted with weeds, gravel and broken concrete.",
        "url": "https://library.municode.com/fl/st._augustine/codes/code_of_ordinances?nodeId=PTIICOOR_CH19NU_ARTIIFORE_S19-16MARE",
        "checked": "2026-09-07"
      },
      {
        "label": "Fernandina Beach Land Development Code Sec. 1.07.00",
        "cite": "\"Impervious surface means a surface that has been compacted or covered with a layer of material so that it is highly resistant to infiltration by water,\" including semi-impervious surfaces such as compacted clay. No reference to artificial or synthetic turf appears anywhere in the LDC.",
        "url": "https://library.municode.com/fl/fernandina_beach/codes/land_development_code",
        "checked": "2026-09-07"
      },
      {
        "label": "Jacksonville Ordinance Code Sec. 654.129",
        "cite": "Sets impervious surface ratios by zoning district at subdivision design stage (RR-Acre 30 percent through RHD 85 percent). The Ordinance Code contains no general definition of impervious surface; stormwater facility design is referred out to the Land Development Procedures Manual.",
        "url": "https://library.municode.com/fl/jacksonville/codes/code_of_ordinances?nodeId=TITXVIILAUS_CH654COSURE_S654.129REIMSTDR",
        "checked": "2026-09-07"
      },
      {
        "label": "HB 803 (2026), ch. 2026-63 — amendment to Fla. Stat. 553.79",
        "cite": "\"A local government that issues building permits shall exempt an owner of a single-family dwelling or the owner's contractor from the requirement to obtain a building permit to perform any work valued at less than $7,500 on the owner's property.\" The exemption does not apply to work on property partially or entirely located in a flood hazard area.",
        "url": "https://www.nassaucountyfl.com/DocumentCenter/View/31830/Chapter-2026-63-HB803",
        "checked": "2026-09-07"
      },
      {
        "label": "Colorado HB25-1113 (2025), signed act",
        "cite": "Amends C.R.S. Title 37 Article 99 to insert \"NONFUNCTIONAL\" before \"artificial turf\" in the prohibition, and adds C.R.S. 37-99-102(6.5) defining functional artificial turf to include playgrounds, sports fields and the playing area of a golf course. Article 99 governs water use; it does not classify turf for stormwater or built-upon-area purposes.",
        "url": "https://content.leg.colorado.gov/sites/default/files/2025a_1113_signed.pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "Thornton Water — 2026 Artificial Turf Rules for the Water-Wise Landscape Rebate",
        "cite": "Requires a minor development permit before installation, backing that drains at a minimum of two inches per hour, a sub-base of at least three inches of compacted aggregate, glued rather than sewn seams, an eight-year fade warranty, and third-party or manufacturer documentation that the product is PFAS-free.",
        "url": "https://www.thorntonwater.com/wp-content/uploads/2026/02/2026-residential_artificial_turf_info__rules-1.pdf",
        "checked": "2026-09-07"
      },
      {
        "label": "New Jersey Department of Environmental Protection — Synthetic Turf: A Review of the Current Science (2025)",
        "cite": "\"Just because a turf product can drain the standard permeability rate of 10 inches per hour, for example, it does not mean the ground underneath will infiltrate at that same rate.\" The review also warns that poor installation and inadequate drainage systems can exacerbate flooding.",
  ...
  },
  {
    ...
    "faq": [
      ...
      },
      {
        ...
        "a": "The only one we found is the City of Thornton, at up to $2.00 per square foot on 200 to 1,000 square foot projects, $2,000 lifetime per residential lot, and only where the turf replaces high-water lawn such as Kentucky Bluegrass on a single-family lot. It needs a Minor Development Permit first, caps turf at 25% of front and unenclosed side-yard landscape area, and requires published PFAS-free documentation."
      },
      {
