...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    description: "Artificial lawn installation with a custom layout, site prep and written price in Denver, the Grand Strand and northeast Florida. Free estimate: 303-349-2368.",
    preset: 'Lawn',
    icon: 'leaf',
  ...
  },
  {
    ...
    lede: "Plan a dog run or pet lawn around the door your dog uses and access for cleaning. We put the layout and price in writing.",
  ...
  },
  {
    ...
    description: "Turf installation for daycares, pet facilities and shared spaces, with use, site prep and care needs defined in the quote. Free estimate: 303-349-2368.",
    ...
    lede: "Plan turf for a daycare, pet facility, courtyard or common area around the people who use it. A free visit, then a written scope and price.",
    ...
    benefits: [
      { icon: "layout", h: "A surface matched to who uses it", p: "Tell us whether it is a play yard, dog run or gathering space, and we compare turf and any pad for that use." },
      { icon: "drop", h: "A price that reflects the real site", p: "Drainage, access and site preparation are checked on the visit, before the scope and price are written." },
      { icon: "clock", h: "Closures agreed before work starts", p: "Delivery, removal and installation access go into the schedule, so you know which areas close and when." },
    ],
  ...
  },
  {
    ...
    lede: "Choose the playing area, lines and surface for your sport. We plan the base and drainage, starting with a free visit and a written price.",
