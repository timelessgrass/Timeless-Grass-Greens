...
export const MARKETS: Market[] = [
  {
    ...
    lede: "Artificial lawns, pet areas and putting greens from Shallotte, NC, to Burgess, SC, and inland to Loris and Conway. Start with a free visit and a written price.",
  ...
  },
  {
    ...
    answer: {"question": "Who installs artificial turf and putting greens in the Denver metro?", "answer": "We install artificial lawns, pet turf and backyard putting greens across the Denver metro. Start with a free visit, turf options, a custom layout and a written price before deciding on installation."},
  ...
  },
  {
    ...
    h1: "A lawn, dog run or putting green for your Florida yard.",
    lede: "Artificial lawns, pet areas and putting greens from Fernandina Beach to St. Augustine Shores. Start with a free visit, a custom layout and a written price.",
    ...
    answer: {"question": "Who installs artificial turf and putting greens in northeast Florida?", "answer": "We install artificial lawns, pet turf and backyard putting greens across northeast Florida, from Fernandina Beach to St. Augustine Shores. A free visit includes turf options, a custom layout and a written price."},
