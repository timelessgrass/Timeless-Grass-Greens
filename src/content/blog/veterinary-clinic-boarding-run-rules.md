...
updated: '2026-09-14'
answer:
  question: Which rule governs turf in a veterinary clinic's boarding or exercise run?
  answer: It depends on whether the practice boards patients only for medical care or actively solicits boarding and daycare business. A clinic that does the second can fall under the state's general kennel-licensing rule instead of its veterinary board's facility rule, and the two set different standards for exercise areas and holding enclosures. Confirm which track applies with your board or licensing agency before the surface is chosen.
faq:
  - q: Does a veterinary hospital in Colorado need a PACFA kennel license to board pets?
    a: Not if boarding is for medical care only. <a href="https://www.animallaw.info/statute/co-pet-shop-article-80-pet-animal-care-and-facilities-act" target="_blank" rel="nofollow noopener">C.R.S. 35-80-103(2)(a)</a> exempts a veterinary hospital that boards pets "for the purpose of veterinary medical care only and does not actively solicit boarding business in any way." A practice that markets boarding or daycare falls under the full Pet Animal Care and Facilities Act kennel rule instead.
  - q: Does North Carolina require an impervious surface in a clinic's exercise area?
    a: No. <a href="https://www.law.cornell.edu/regulations/north-carolina/21-N-C-Admin-Code-66-0207" target="_blank" rel="nofollow noopener">21 NCAC 66 .0207</a> requires an impervious surface only on the examination table and the operating table. Cages, exercise areas, pens and stalls must instead be "clean and orderly," well lit and in good repair, and the Board inspects any new or newly-sold facility before veterinary practice begins there.
  - q: Does South Carolina require nonporous holding enclosures at every clinic?
    a: No. The "durable, nonporous, impervious to moisture" standard is <a href="https://www.scstatehouse.gov/coderegs/Chapter%20120.pdf" target="_blank" rel="nofollow noopener">Reg. 120-12(B)(3)</a>, and 120-12 defines the covered "facility" as an animal shelter that also provides veterinary services. A private clinic's premises answer to 120-10 instead, which sets general sanitation, lighting and equipment standards but no impervious rule for a run.
  - q: What does Florida require of a clinic's exercise runs?
    a: 'An exercise run is optional under <a href="https://www.law.cornell.edu/regulations/florida/Fla-Admin-Code-Ann-R-61G18-15-002" target="_blank" rel="nofollow noopener">Fla. Admin. Code R. 61G18-15.002</a>, but where a practice has one it must be "clean and secure" with "no hazards." Holding areas, which are mandatory, must be "capable of sanitation," with proper ventilation, lighting and a size suited to the animal.'
sources:
  - label: 'C.R.S. 35-80-103, Scope of article (Pet Animal Care and Facilities Act), West''s CRS text at the Animal Legal & Historical Center'
    url: https://www.animallaw.info/statute/co-pet-shop-article-80-pet-animal-care-and-facilities-act
    checked: '2026-09-14'
  - label: '21 NCAC 66 .0207, Minimum Facility and Practice Standards (Cornell LII)'
    url: https://www.law.cornell.edu/regulations/north-carolina/21-N-C-Admin-Code-66-0207
    checked: '2026-09-14'
  - label: 'S.C. Code of Regulations Chapter 120, sections 120-10 (Veterinary Facilities) and 120-12 (Veterinary Medicine and Animal Shelters)'
    url: https://www.scstatehouse.gov/coderegs/Chapter%20120.pdf
    checked: '2026-09-14'
  - label: 'Fla. Admin. Code R. 61G18-15.002, Minimum standards for premises (Cornell LII)'
    url: https://www.law.cornell.edu/regulations/florida/Fla-Admin-Code-Ann-R-61G18-15-002
    checked: '2026-09-14'
publicReferences:
  - https://www.law.cornell.edu/regulations/north-carolina/21-N-C-Admin-Code-66-0207
  - https://www.scstatehouse.gov/coderegs/Chapter%20120.pdf
  - https://www.law.cornell.edu/regulations/florida/Fla-Admin-Code-Ann-R-61G18-15-002
related:
  services:
    - pet-turf
    - commercial-turf
  markets:
    ...
    - northeast-florida
  guides:
    - artificial-turf-for-kennels-and-dog-daycares
---
...
4. **Has the state's current rule text been confirmed with the board or licensing agency?** Rules get amended; check the current version before ordering, and keep the confirmation on file alongside the [care routine we walk you through](/blog/how-to-clean-pet-turf/) after install.
...
Once you know which standard the run has to meet, we handle the rest: the free visit to measure and check the ground, a layout you approve, and turf built for a space that gets cleaned every day. Our [pet turf](/services/pet-turf/) page has the detail on how we build a run for daily use.
