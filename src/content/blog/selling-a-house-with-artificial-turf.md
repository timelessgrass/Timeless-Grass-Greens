---
status: published
title: Turf and Your Disclosure Form | TIMELESS Grass & Greens
description: See which questions on your state's seller disclosure form your turf project touches, in Colorado, North Carolina and South Carolina, and what to have ready.
h1: 'Selling a house with artificial turf: what the disclosure forms ask'
topic: Costs and planning
published: '2026-09-12'
updated: '2026-09-12'
answer:
  question: 'Selling a house with artificial turf: what does the disclosure form ask?'
...
faq:
  ...
  - q: What should I have on hand before I fill out the form?
    a: Your HOA or architectural-committee approval letter for the turf (if one was required), any building or excavation permit pulled for the work, and notes on how the area drains and whether grading changed. These map directly to the questions above, so gathering them first makes the form faster and the answers accurate.
sources:
  - label: 'Colorado Real Estate Commission: SPD19 Seller''s Property Disclosure (Residential), adopted 5 Aug 2025, mandatory 1 Jan 2026'
    url: https://dre.colorado.gov/sites/dre/files/documents/Seller%27s%20Property%20Disclosure%20%28Residential%29%20CLEAN.pdf
    checked: '2026-09-12'
  - label: 'North Carolina Real Estate Commission: Residential Property and Owners'' Association Disclosure Statement, REC 4.22'
    url: https://www.ncrec.gov/Forms/Consumer/rec422.pdf
    checked: '2026-09-12'
  - label: 'S.C. Code Title 27, Chapter 50: Residential Property Condition Disclosure Act, Section 27-50-40'
...
For what an HOA can and can't require of Colorado turf in the first place, see our [guide to Colorado HOA turf rules](/guides/colorado-hoa-turf-rules/) and [Can your HOA restrict an artificial turf project?](/blog/can-my-hoa-stop-artificial-turf/)
...
We measure the ground and check drainage on the free visit before any [residential turf](/services/residential-turf/) project, and you approve the layout before work starts — keep that plan and any written correspondence with your file. If you're removing old turf as part of the sale, the same records apply; see our [turf removal and replacement](/services/turf-removal-and-replacement/) page.

## A short checklist before you sign

1. **Find your HOA or architectural approval letter**, or confirm none was required.
2. **Pull any permit** issued for grading, drainage or electrical tied to the project.
3. **Write down how the area drains** and note any change in grading.
4. **Check your state's form or statute** — SPD19 Sections J, L and M in Colorado; REC 4.22 Sections E and H in North Carolina; Section 27-50-40 in South Carolina.
5. **Ask your listing agent or attorney** how to answer, particularly if anything above is unresolved or in dispute — this article summarizes the forms, it doesn't tell you how to fill them out.
