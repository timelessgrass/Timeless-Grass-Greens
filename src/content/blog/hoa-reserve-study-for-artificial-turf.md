---
status: published
title: How an HOA Reserve Study Should Carry Turf | TIMELESS Grass & Greens
description: Florida reserves are computed item by item from remaining useful life and replacement cost. Colorado requires a written policy. Here's what that means for turf.
h1: How should an HOA carry artificial turf in its reserve study?
topic: Costs and planning
published: '2026-09-12'
updated: '2026-09-12'
answer:
  question: How should an HOA carry artificial turf in its reserve study?
  answer: "Artificial turf in a common area is a capital item like any other, so it gets its own line: an estimated remaining useful life and a replacement cost. In Florida, that's how the statute requires every reserve component to be computed. Colorado doesn't set a formula, but every association must adopt a written policy saying when a study happens and what it covers. Ask your manager which policy your turf falls under."
faq:
  - q: Does Florida require our HOA to have a reserve study at all?
    a: Only if the association has reserve accounts, or reserves are proposed in the budget. Once a reserve account exists, <a href="https://www.flsenate.gov/Laws/Statutes/2025/720.303" target="_blank" rel="nofollow noopener">Fla. Stat. 720.303(6)(e)</a> requires the amount in it to be computed by a formula based on each item's estimated remaining useful life and estimated replacement cost or deferred maintenance expense. That formula is what turns into a study.
  - q: Can our Florida board just vote to skip reserving for the turf this year?
    a: 'The membership can, not the board alone. <a href="https://www.flsenate.gov/Laws/Statutes/2025/720.303" target="_blank" rel="nofollow noopener">Fla. Stat. 720.303(6)(f)</a> lets the membership vote, at a meeting with a quorum, to have no reserves or less than the formula would require. That vote covers one budget year only and has to be taken again for the next one.'
...
sources:
  - label: 'Fla. Stat. 720.303: HOA powers and duties, including reserve accounts (subsections (6)(e), (6)(f), (6)(h))'
    url: https://www.flsenate.gov/Laws/Statutes/2025/720.303
    checked: '2026-09-12'
  - label: 'C.R.S. 38-33.3-209.5: Colorado Common Interest Ownership Act, reserve study policy requirement (subsection (1)(b)(IX))'
    url: https://codes.findlaw.com/co/title-38-property-real-and-personal/co-rev-st-sect-38-33-3-209-5/
    checked: '2026-09-12'
related:
  services:
    - commercial-turf
...
Florida doesn't require every HOA to reserve for anything. The requirement turns on whether the association has reserve accounts, or reserves are proposed in the budget, in the first place ([Fla. Stat. 720.303](https://www.flsenate.gov/Laws/Statutes/2025/720.303)).
...
3. **Whether the study is based on a physical analysis and a financial analysis**, or something less.
...
For the separate question of whether your HOA can restrict turf in the first place, see our guide to [Colorado HOA turf rules](/guides/colorado-hoa-turf-rules/) and [Florida-friendly landscaping and HOAs](/guides/florida-friendly-landscaping-and-hoas/) — reserves and approval are two different questions, governed by different parts of each state's law.
