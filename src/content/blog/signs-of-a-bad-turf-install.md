---
status: published
title: Signs of a Bad Artificial Turf Install | TIMELESS Grass & Greens
description: Open seams, lifting edges, persistent puddles or washed-out infill deserve a closer look. What to document and ask before paying for a turf repair.
h1: What does a bad turf install look like?
...
sources:
  - label: '21 NCAC 28B .0503(b), North Carolina Landscape Contractors'' Licensing Board rules: the written artificial turf install standard'
    ...
    checked: '2026-09-08'
  - label: 'Raspanti et al., New Jersey DEP Division of Science & Research: synthetic turf science report, October 2025 (drainage, installation and infill loss)'
...
Walk the lawn from a few directions and take a closer look at the places that feel different underfoot. Useful things to show an installer include an opening seam, a raised edge, a new ripple or dip, and areas where infill repeatedly collects on a path.

Photograph the whole area as well as the detail. Record whether it has looked that way since installation or appeared later. A seam that looks different from one viewing angle needs a different conversation from a seam that has opened into a gap.

If an edge or seam has become a trip hazard, keep people away from that spot until it can be assessed. Contact the installer before attempting a repair or adding material, particularly if the work may be covered by a warranty.
...
## Compare the work with what was promised
...
For a new installation or a substantial repair, make these details visible in the estimate:

- The product, intended use and area covered by the price.
- The planned ground preparation, base and route for water.
- How seams, edges and transitions to paths will be finished.
- The infill specified for that product and use.
