...
h1: 'Metro District or HOA: Who Reviews Your Turf or Putting Green Plan in a Denver-Metro Master-Planned Community'
topic: Local rules
published: '2026-09-14'
updated: '2026-09-14'
answer:
  question: In a Denver-metro master-planned community, does the metro district or the HOA approve a turf or putting-green plan?
  answer: It depends on the paperwork, not on what's normal elsewhere. A metropolitan district can hold covenant enforcement and design review power under C.R.S. 32-1-1004(8)(a), but only if a contract with the master association grants it, or the declaration itself names the district. Ask your association or district manager which document applies to your address before you submit a plan.
faq:
  - q: Can a metropolitan district really approve my landscaping plan?
    a: Yes, if the paperwork supports it. Under <a href="https://colorado.public.law/statutes/crs_32-1-1004" target="_blank" rel="nofollow noopener">C.R.S. 32-1-1004(8)(a)</a>, a district may provide covenant enforcement and design review for an area within it if either the master association and district have a contract defining that duty, or the declaration or a similar covenant document names the district as the enforcement or design review body. Ask which condition applies to your community.
  ...
  - q: Can I find both documents myself before the free visit?
    a: Often, yes. Closing documents typically include the declaration and any separate covenant enforcement agreement. Your title company, property manager, or the district manager can confirm which one governs design review for your address, and whether a metro district or the master association handles it.
sources:
  - label: 'C.R.S. 32-1-1004(8)(a) and (8)(b), metropolitan district covenant enforcement and design review powers'
    url: https://colorado.public.law/statutes/crs_32-1-1004
    checked: '2026-09-14'
  - label: 'C.R.S. 38-33.3-106.5(1)(i.5), Colorado Common Interest Ownership Act: association design guidelines and nonvegetative turf grass in the backyard'
    url: https://colorado.public.law/statutes/crs_38-33.3-106.5
    checked: '2026-09-14'
  - label: 'Sterling Ranch Community Authority Board, Design Review Documents'
    url: https://www.sterlingranchcab.com/201/Design-Review-Documents
    checked: '2026-09-14'
related:
  services:
    - residential-turf
...
Our [guide to Colorado's HOA turf rules](/guides/colorado-hoa-turf-rules/) covers what an association's design guidelines can and can't restrict. This article covers the layer above that: when a metropolitan district, rather than the association, is the one holding that review power in the first place. A related question inside single-owner communities — [who approves turf when a district and an HOA both exist](/blog/cdd-or-hoa-who-approves-turf/) — comes up under Florida's community development district law; Colorado's metropolitan district statute sets its own two-part test, and that's what this article walks through.
...
If your community is built around a metropolitan district, don't assume it works the same way as [Sterling Ranch](/denver-metro/sterling-ranch-co/) or [Castle Pines](/denver-metro/castle-pines-co/). Ask which public body, if any, holds design review authority for your address, and get the name of the specific document that grants it.
...
That's a reason to read the declaration itself, not just whatever design-review handbook your district or association hands you. Our [Colorado city artificial turf codes guide](/guides/colorado-city-artificial-turf-codes/) has the municipal layer that can sit on top of both.

## What a professional install plans around

Once you know which body reviews your plan, a [custom turf or putting-green layout](/services/residential-turf/) still has to answer the questions any reviewer will ask:
